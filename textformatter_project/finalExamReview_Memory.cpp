...
int main() {
  ...
  fraction c(1,3);
  cout << a << "\n";
  fraction d = b.add(c); // regular method **done 
  fraction e = fraction::add(b,c); // static function ** done static is similar to friend, just replace friend by static 
  fraction f = b + c; // friend binary operator 
  fraction g = add(b,c); // friend function ** done
  cout << "d=" << d << '\n';
  cout << "e=" << e << '\n';
  cout << "f=" << f << '\n';
